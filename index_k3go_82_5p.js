...
const Vn_go_5p = require("./82com/auto82/k3_go_5p_82");


const token = '7155708093:AAEpUMrEUzUAW4iEwm9apt91fDhaDa1eGh0';
console.log(" ------------------- bắt đầu bot VN GO 82COM---------------------------")
const adminGroup = require('./82com/admingroup_82_5p')
...
bot.on('message', async (msg) => {
    ...
    if (type == 'group' || type =="supergroup") {
        if (text) {
            ...
            if (chatId==-1002059679492 && (check == '/' || check=="A") ) {
